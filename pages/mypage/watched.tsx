...
export default function attended() {
    ...
    return (
        <Layout hasTabBar canGoBack title="최근 본 모임">
            <div className="bg-white flex max-w-screen-sm w-96 flex flex-col">
                    ...
                    <ul id="attendMeeting" className="mb-4 w-80">
                        <li className="">
                            <div className="mx-9 justify-between w-80 h-24 border-2 border-black flex">
                                <div className="w-40">
                                    <p className="w-40" style = {{ fontSize: '15px'}}>{recruitment}</p>
                                </div>
                                <div className="w-40">
                                    <p className="w-40" style = {{ fontSize: '15px'}}>{wirter}</p>
                                </div>
                            </div>
                        </li>
                    </ul>
